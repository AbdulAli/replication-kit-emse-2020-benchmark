...
public abstract class AbstractWekaEvaluation implements IEvaluationStrategy {
     ...
     */
    @Override
    public void apply(String experimentName,
    					Instances testdata,
                      Instances traindata,
                      ...
                      List<IResultStorage> storages)
    {
        ...
        if (writeHeader) {
            output.append("technique,configuration,window,split,project,size_test,size_training");
            for (ITrainer trainer : trainers) {
        ...
        output.append(experimentName.split("-")[1]);
        
        String config = productName.split("Configuration")[1].split("_")[0];
        String window = productName.split("window")[1].split("_")[0];
        String split = productName.split("split")[1].split("_")[0];
        String project = productName.split("project")[1].split(".csv")[0];
